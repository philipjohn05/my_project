...
Welcome to my [personal website](https://pjfaraon.com)! This is an React-based Jamstack application. It offers a simple interface, easy modifications, static export capabilities, and free automatic deployments via [GitHub Pages](https://pages.github.com/).
...
1. Clone the repository:
   ...
   ```bash
   git clone git://github.com/philipjohn05/my_project.git
   cd personal-site
   ```
...
---
*Last updated: September 2025 - Testing automated deployment*
